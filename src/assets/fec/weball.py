"""Candidate Summary Asset - Parse FEC candidate summary files (weball.zip) using raw FEC field names"""
...
@asset(
    name="weball",
    description="FEC candidate summary file (weball.zip) - raw FEC data with original field names",
    group_name="fec",
...
def weball_asset(
    ...
    """Parse weball.zip files and store in fec_{cycle}.weball collections using raw FEC field names."""
